...
| DE `06-batch/...10-joins-in-spark-04-broadcast-exchange-crisp.png` | matching `.jpg` + `-cropped.png` | `exec-645af126-0ce5-48ca-826c-7f6e9d611f7c` | `f66a710` | Regenerated without selection highlights or webcam; accepted by independent review |
| DE `06-batch/...11-operations-on-spark-rdds-06-dag-two-stages-crisp.png` | matching `.jpg` + `-cropped.png` | `exec-fdb4e6dc-503a-418f-b290-d0f33ad4bec3` | `63927e9` | Regenerated skipped/active RDD DAG; pending independent review |
| DE `06-batch/...12-spark-rdd-mappartition-02-feature-columns-crisp.png` | matching `.jpg` + `-cropped.png` | `exec-4ec4adcf-e874-48a6-9c77-1615400d3695` | `aff59ee` | Regenerated feature selection output; pending independent review |
| DE `06-batch/...13-connecting-to-google-cloud-storage-03-upload-progress-crisp.png` | matching `.jpg` + `-cropped.png` | `exec-47b7dda1-6e70-4018-9ddd-67c4c58b2c27` | `c3e895c` | Follow-up generation corrected `.coc` to exact `.crc`; pending independent re-review |
| DE `06-batch/...14-creating-a-local-spark-cluster-02-worker-registered-crisp.png` | matching `.jpg` + `-cropped.png` | `exec-0db64305-9e64-4760-8f82-c61e6aaa26d3` | `0806220` | Regenerated worker `ALIVE` UI and resource rows; pending independent review |
| DE `06-batch/...15-setting-up-a-dataproc-cluster-02-submit-job-form-crisp.png` | matching `.jpg` + `-cropped.png` | `exec-74c19585-1af4-4137-8500-b047d5c9b610` | `16b4254` | Regenerated exact green/yellow/report arguments; pending independent review |
| DE `06-batch/...15-setting-up-a-dataproc-cluster-05-reports-in-bucket-crisp.png` | matching `.jpg` + `-cropped.png` | `exec-3511bef5-af63-4b99-b8a9-ed679d96d569` | `d2432e1` | Regenerated exact `code/`, `pq/`, `report-2020/`, `report-2021/` folders; pending independent review |
