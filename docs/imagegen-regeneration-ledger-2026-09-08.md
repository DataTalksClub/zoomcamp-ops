...
| DE `06-batch/...09-groupby-in-spark-02-three-stages-crisp.png` | matching `.jpg` + `-cropped.png` | `exec-3fdc8c80-a6d9-4d4a-9dc3-46a2fc0649ae` | `fae367c` | Regenerated as a sharp DAG; stages 9–11 and labels checked; pending independent review |
| DE `06-batch/...09-groupby-in-spark-04-shuffle-read-write-crisp.png` | matching `.jpg` + `-cropped.png` | `exec-9fcc0df1-670e-4587-8e4a-6f5cc16b5281` | `d58916e` | Regenerated as a sharp stage table; task counts and `425.1 MiB` checked; pending independent review |
| DE `06-batch/...10-joins-in-spark-02-sort-merge-join-stages-crisp.png` | matching `.jpg` + `-cropped.png` | `exec-7d640ab4-981e-4375-9009-5ce3c571aafc` | `aa152cf` | Regenerated as a sharp two-input sort-merge DAG; pending independent review |
| DE `06-batch/...10-joins-in-spark-04-broadcast-exchange-crisp.png` | matching `.jpg` + `-cropped.png` | `exec-645af126-0ce5-48ca-826c-7f6e9d611f7c` | `f66a710` | Regenerated without selection highlights or webcam; broadcast-job evidence checked; pending independent review |
