...
| ML `08-deep-learning/...07-checkpointing-01-oscillation-crisp.png` | matching `.jpg` + `-cropped.png` | `exec-0464f808-e981-441a-8605-4b376a828f66` | `212beaa` | Regenerated with the intentional epoch-8 annotation retained; independent review pending |
