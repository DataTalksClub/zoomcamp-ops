...
| ML `02-regression/...04-fake-feature-crisp.png` | matching `.jpg` + `-cropped.png` | `exec-33001cc1-800e-46ae-9170-86d91ade1128` | `d91767d` | Regenerated without webcam/browser chrome; exact vectors, `n+1 dim`, crossed-out `xᵢ₀`, blue `1`, and final equation checked; independent review pending |
| ML `02-regression/...05-prepend-one-crisp.png` | matching `.jpg` + `-cropped.png` | `exec-b63da2f8-51d8-4d39-ab18-79566012aa1d` | `d91767d` | Regenerated without webcam/chrome/green selection border; exact code and `[7.17, 0.01, 0.04, 0.002]` checked; independent review pending |
...
| ML `08-deep-learning/...03-pretrained-models-02-imagenet-crisp.png` | `...03-pretrained-models-02-imagenet.jpg` + improved body crop | `exec-403e3100-7497-45a0-b5ad-846f775bcba0` | `10bae47` | Rejected in independent review: sharp but clipped the logo/headings and retained a green browser strip; superseded below |
| ML `08-deep-learning/...07-checkpointing-01-oscillation-crisp.png` | matching `.jpg` + `-cropped.png` | `exec-f65db983-5999-459c-a80d-29d42ea92646` | `8b3c581` | Regenerated as a chart-focused crop with the intentional epoch-8 annotation retained; the lesson caption supplies the context; independent review pending |
| ML `08-deep-learning/...08-more-layers-02-activation-functions-crisp.png` | matching `.jpg` + `-cropped.png` | `exec-a6377bca-7b19-4393-9bb7-d79894e75783` | `36a22a2` | Regenerated as a clean two-plot crop; the lesson caption supplies the ReLU context; independent review pending |
| ML `04-evaluation/...07-cross-validation-01-kfold-diagram-pilot.png` | matching `.jpg` + bounded crop | `exec-e510e308-ad04-4a45-bf5d-2a4646be2da8` | `7e6620c` | Worker checked semantics and overlays; independent review pending |
| ML `09-serverless/...01-intro-04-module-plan-crisp.png` | matching `.jpg` + bounded crop | `exec-9143041e-2ded-4b20-88ee-42e4f18bd08d` | `bc52fcb` | Worker reports exact module-plan replacement; independent review pending |
| ML `09-serverless/...01-intro-05-module-plan-lambda-gateway-crisp.png` | matching `.jpg` + bounded crop | `exec-cb244edd-b860-490a-b1eb-0493651f3a26` | `bc52fcb` | Worker reports exact module-plan replacement; independent review pending |
| ML `09-serverless/...03-tensorflow-lite-06-keras-preprocess-source-crisp.png` | matching `.jpg` + bounded crop | `exec-87bcf080-161c-4d66-8ba6-9c9165dcdffc` | `bc52fcb` | Worker reports a clean replacement, but the changed aspect ratio remains an unresolved exactness check |
| ML `10-kubernetes/...02-tensorflow-serving-01-saved-model-crisp.png` | matching `.jpg` + bounded crop | `exec-25d43348-7668-4c7d-b2e4-f4f1d4e61f50` | `31049ba` | Worker checked exact terminal text/tree/URL and removed overlays; independent review pending |
| ML `08-deep-learning/...03-pretrained-models-02-imagenet-crisp.png` | original `.jpg` + `/tmp/imagenet-body-crop.png` | `exec-d2c37784-1839-41cf-b5f9-158b930b2b40` | `4e56d95` | Corrected clipped viewport with a complete clean page section; fresh independent review pending |
| ML `08-deep-learning/...03-pretrained-models-03-sagemaker-gpu-crisp.png` | original `.jpg` + `/tmp/sagemaker-settings-crop.png` | `exec-8a130d32-d028-4262-984d-299ad6ed8981` | `ca6dd36` | Corrected clipped AWS viewport with a complete centered settings card; independent review accepted |
| ML `08-deep-learning/...03-pretrained-models-04-xception-model-crisp.png` | matching `.jpg` + bounded crop | `exec-895a1c1b-c01c-472f-9145-7acb8a5db0b5` | `1ad6a86` | Exact code/UUID/299×299 context; independent review accepted |
| ML `08-deep-learning/...03-pretrained-models-05-xception-weights-download-crisp.png` | matching `.jpg` + bounded crop | `exec-0d469488-6a89-4248-9ce2-d435c8053857` | `945499a` | Exact download URL/progress and context; independent review accepted |
| ML `08-deep-learning/...03-pretrained-models-06-batch-shape-crisp.png` | matching `.jpg` + bounded crop | `exec-ff2c7d7c-702d-4abb-a879-ba5d3d0b09c6` | `f4ff4b5` | Exact `(1, 299, 299, 3)` output; independent review accepted |
| ML `08-deep-learning/...03-pretrained-models-07-preprocess-input-crisp.png` | matching `.jpg` + bounded crop | `exec-226d8646-ae1c-4e89-8231-b160dcdc1c3a` | `e19813a` | Exact preprocessing code/output and annotation context; independent review accepted |
