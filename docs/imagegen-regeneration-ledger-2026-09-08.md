...
| DE `06-batch/...13-connecting-to-google-cloud-storage-03-upload-progress-crisp.png` | matching `.jpg` + `-cropped.png` | `exec-25c409f7-44dd-4102-9a14-974bebaa064a` | `e8e2868` | Regenerated completed `380/380` upload state; pending independent review |
